...
public class TraitFieldTMSImpl implements TraitFieldTMS, Externalizable {
    ...
    public TraitFieldTMSImpl() {
        System.out.println( "Created a Field TMS" );
    }
    ...
    public Object donField( String name, TraitType trait, String defaultValue, Class klass ) {
        TraitField fld = fieldTMS.get( name );
        modificationMask |= 1 << fld.getPosition();
        return fld.don( trait, defaultValue != null ? MVEL.eval( defaultValue, klass ) : null, getKlass( klass ), workingMemory );
    }
