...
public class TraitField implements Serializable, Externalizable {
    ...
    private boolean ensureType( Object value, Class<?> range, WorkingMemory wm ) {
        ...
        if ( range.isInstance( obj ) ) {
            ...
            if ( trait != null && trait.logical() ) {
                Object newTrait = don( obj, range, wm );
    ...
    public Object don( TraitType trait, Object defaultValue, TypeWrapper wrapper, WorkingMemory wm ) {
        disableExplicitSet();
        ...
        try {
            ...
            if ( value != null ) {
                if ( klass.isInstance( value ) ) {
                    ...
                    return donTraitable( (TraitableBean) value, klass, wm );
                    ...
                    return donTraitable( core, klass, wm );

                } else {
                    boolean isFullyTraitable = inspectForTraitability( value, wm );
                    if ( isFullyTraitable ) {
                        TraitProxy proxy = (TraitProxy) don( value, klass, wm );
    ...
    private Object donTraitable( TraitableBean obj, Class<?> klass, WorkingMemory wm ) {
        if ( klass.isInstance( obj ) ) {
            return obj;
        } else if ( obj.hasTraits() && obj.hasTrait( klass.getName() ) ) {
            // klass may be a trait, and that trait is already available: do nothing
            return ((TraitableBean) value).getTrait( klass.getName() );
        } else {
    ...
    private Object don( Object obj, Class<?> klass, WorkingMemory wm ) {
        KnowledgeHelper knowledgeHelper = ((DefaultAgenda) wm.getAgenda()).getKnowledgeHelper();
        return knowledgeHelper.don( obj, klass, true );
    }
    ...
    public void shed( TraitType trait ) {
